            ...
            <form id="registerForm" @submit.prevent="register" method="post" action="/api/v1/auth/register">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="location" type="text" id="location" class="form-control" placeholder="Enter location">
                    </div>
                    <div class="col-md-12">
                        <label for="biography" class="form-label">Biography</label>
                        <textarea name="biography" id="biography" class="form-control" placeholder="Tell us about yourself"
                                  rows="5"></textarea>
                    </div>
                </div>
                <div class="mb-3 mt-3">
